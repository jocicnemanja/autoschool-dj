...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'autoschool_new';
    ...
    'jhipster.mail.from' = 'autoschool_new@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'autoschool_new API';
    'jhipster.swagger.description' = 'autoschool_new API documentation';
    ...
    'eureka.instance.appname' = 'autoschool_new';
    'eureka.instance.instanceId' = 'autoschool_new:${random.value}';
    ...
    'cloud.config.name' = 'autoschool_new';
