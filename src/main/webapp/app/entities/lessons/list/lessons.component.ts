...
export class LessonsComponent implements OnInit {
  ...
  trackId(index: number, item: ILessons): number {
    return item.id!;
  }

  delete(lessons: ILessons): void {
    const modalRef = this.modalService.open(LessonsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.lessons = lessons;
  ...
  protected onSuccess(data: ILessons[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
